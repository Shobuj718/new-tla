...
@section('title', 'User Pending List')
...
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            ...
            <li><i aria-hidden="true"></i><a href="#">User Pending List</a></li>
        </ul>
    </div>
</div>
    ...
    <div class="col-sm-12">
        <div class="panel b-primary bt-md">
            <div class="panel-content">
            	<h4 class="section-subtitle"><b>User Pending List</b>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#userTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{route('users.getUserPendingList')}}",
            columns: [
                { data: 'id' },
                { data: 'name' },
                { data: 'username' },
