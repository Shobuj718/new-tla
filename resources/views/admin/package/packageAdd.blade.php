    ...
    <form id="inlinevalidation" name="inlinevalidation" class="form-stripe">
        ...
        <div class="modal-content-area">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="first_month_subscription_fee" name="first_month_subscription_fee" >
            </div>  
            <div class="form-group">
                <label for="subscription_fee" class="control-label">Subscription Fee<span class="required">*</span></label>
                <input type="text" class="form-control" id="subscription_fee" name="subscription_fee" >
            </div>
            <div class="form-group">
                <label for="max_bids" class="control-label">Max Bids<span class="required">*</span></label>
                <input type="text" class="form-control" id="max_bids" name="max_bids" >
            </div>
            <div class="form-group">
                <label for="max_skills" class="control-label">Max Skills<span class="required">*</span></label>
                <input type="text" class="form-control" id="max_skills" name="max_skills" >
            </div>
            
            <div class="form-group">
                <label for="summaryckeditor" class="control-label">Description</label>
                <textarea class="form-control" type="text" id="summaryckeditor" class="summaryckeditor" id="summaryckeditor" name="summaryckeditor"></textarea>
            </div>
        </div>
