        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="submit-project-content">
                    <div class="card-body">
                        <form name="clientCaseEdit" id="clientCaseEdit">
                            @csrf
                                                      
                            <div class="form-group row pt-0">
                                <label for="projectitle" class="col-sm-4 col-form-label">Case Title <span>Keep it short &amp; clear</span></label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="title" id="title" value="{{ $project->title ?? '' }}" placeholder="Enter your case title">
                                    <input type="hidden" class="form-control"  value="{{ $project->slug ?? '' }}" name="slug" id="slug" placeholder="Enter your case title">
                                                                    </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="budget" id="budget"  class="form-control" value="{{ $project->budget ?? '' }}" aria-label="Amount (to the nearest dollar)">
                                ...
                                <div class="col-sm-8">
                                    <div class="pac-card" id="pac-card">
                                        <div id="pac-container">
                                            <input id="location_name" name="location_name" class="form-control pac-target-input" type="text" value="{{ $project->location_name ?? '' }}" placeholder="Enter a location" autocomplete="off">
                                            <input type="hidden" id="lat" name="lat" value="{{ $project->lat ?? '' }}">
                                            <input type="hidden" id="lng" name="lng" value="{{ $project->lng ?? '' }}">
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="post_code" class="form-control" id="post_code" value="{{ $project->post_code ?? '' }}" title="Post Code">
                                                                    </div>
...
<script src="https://live.miyn.app/miyn-widget-4/js/jquery-ui.js"></script>
...
<script type="text/javascript">
 ...
 // Wait for the DOM to be ready
    ...
    $(function() {
      $("form[name='clientCaseEdit']").validate({
        rules: {
          budget: "required",
          title: "required",
        ...
        messages: {
          budget: "Please enter your firstname",
          title: "Please enter your firstname",
          location_name: "Please enter your firstname",
          post_code: "Please enter your firstname",
          description: "Please enter your firstname",
          category_id: "Please enter your firstname",
          category_id: "Please enter your firstname"
        },
        submitHandler: function(form) {
          //form.submit();
        		...
        		if(file_data !="") {
        			...
        			fd.append("attachment", file_data);
        		}
                ...
                axios({
                    method: 'post',
                    url: "{{route('client.case.update', $project->slug ?? '')}}",
                    data: fd,
                    _token: '{!! csrf_token() !!}',
