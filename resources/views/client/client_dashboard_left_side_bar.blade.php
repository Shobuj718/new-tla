<div class="col-lg-4 col-md-4 col-sm-12 d-none d-md-block dashboard-tab">
    <div class="user-info dashboard-tablist" style="border-top: 5px solid #00c3c0;">
        ...
        <a href="{{ route('client.edit.profile', $user->uid)  }}" style="font-size:13px; margin-top:20px; margin-left:auto; margin-right:auto;display:block;clear:both; color:#00c3c0;">Edit Profile</a>
    </div>
    <div class="dashboard-menu dashboard-tablist">
        ...
        <ul>
            ...
            <li><a href="{{ route('client.get.case', $user->uid) }}"><i class="fa fa-briefcase"></i> Available Cases</a></li>
            <li><a href="{{ route('client.new.case', $user->uid) }}"><i class="fa fa-briefcase"></i> New Milestone</a></li>
            <li><a href="{{ route('client.payment', $user->uid) }}"><i class="fa fa-credit-card"></i> Payments</a></li>
            <li><a href="{{ route('client.conversations', $user->uid) }}"><i class="fa fa-envelope-o"></i> Conversations <span id="topbar_messages_count">1</span> </a></li>
    ...
    <div class="status-menu dashboard-tablist">
        <h2>Status</h2>
            <ul class="list-info-company">
                ...
                <li class="active"> <a href="{{ route('client.approved.case', $user->uid) }}">Approved Cases <span class="info"></span></a></li>
                <li> <a href="{{ route('client.pending.case', $user->uid) }}">Pending Cases <span class="info"></span></a></li>
                <li> <a href="{{ route('client.active.case', $user->uid) }}">Active Cases <span class="info">0</span></a></li>
                <li> <a href="{{ route('client.complete.case', $user->uid) }}">Complete Cases <span>0</span></a></li>
