...
@section('content')
 ...
 <div class=" breadcrumb-row">
    <div class="container">
        <div class="tla-breadcrumbs">Client / Create case</div>
    </div>
</div>
                ...
                <div class="client-edit-profile-first-column-inner">
                    ...
                    <div class="border_1p whitebg client-edit-profile-first-column-bottom-box">
                        <div class="user_function">
                            <ul>
                                <li><a href="https://demo.thelawapp.com.au/upgrade"><i class="fa fa-money"></i>Account Details</a></li>
                                <li><a href="https://demo.thelawapp.com.au/nupurbss"><i class="fa fa-eye"></i> Verify your phone</a></li>                                          
                                ...
                                <li><a href="https://demo.thelawapp.com.au/logout" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                    <i class="fa fa-sign-out"></i>Logout </a>
                                
                                    <form id="logout-form" action="https://demo.thelawapp.com.au/logout" method="POST" style="display: none;">
            ...
            <div class="post-case-middle-column pl15 width75">
                <div class="client-edit-profile-middle-column-inner">
                    <div class="border_1p whitebg client-edit-profile-middle-column-box client-edit-profile-middle-column-box1 mb15 plr25 ptb10">
                        <form  id="clientCaseCreated" name="clientCaseCreated">
...
<script type="text/javascript">
 ...
 // Wait for the DOM to be ready
    ...
    $(function() {
      $("form[name='clientCaseCreated']").validate({
        rules: {
          title: "required",
          budget: "required",
        ...
        submitHandler: function(form) {
          //form.submit();
                ...
                console.log('Called');
                var form = $('#clientCaseCreated')[0];       
                var bodyFormData = new FormData(form);    
                
                axios({
                    method: 'post',
                    url: "{{route('client.case.store')}}",
                    data: bodyFormData,
