...
<div class=" breadcrumb-row">
    <div class="container">
        <div class="tla-breadcrumbs">Dashboard / Cases</div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="dashboard-content">
            <div class="row">
                 ...
                 @include('client.client_dashboard_left_side_bar')                      
                    ...
                    <div class="search-dashboard" style="border-top: 5px solid #00c3c0;">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-3 col-sm-12 case-profile-link">
                                ...
                                <a class="btn boxed_btn" href="{{ route('client.case.create', $user->uid) }}">Create Case</a>
                            </div>
                        </div>
                    ...
                    @foreach($cases as $case)
                        ...
                        <div class="case-short-description">
                            <p>
                                ...
                                <a href="{{ route('client.case.show', $case->slug) }}">view</a>
                            </p>
                        </div>
